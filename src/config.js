...
// Si cambia el puerto de la API o los datos del proyecto, solo se modifica aquí.

// URL base del backend local de Agenda ADSO.
// Si cambia el puerto o la ruta, solo se modifica en este archivo.
export const API_BASE_URL = "http://localhost:3002/contactos";

// Información general de la aplicación utilizada en App.jsx
